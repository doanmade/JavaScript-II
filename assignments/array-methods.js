...
//     function firstLast(){
//         console.log(`Runners First Name: ${runners[i].first_name}, Last Name: ${runners[i].last_name}`);
//     }
//     firstLast()
// }

// let fullName = [];
// runners.forEach(currentValue => fullName.push("Runners First Name: " + currentValue.first_name + ", Last Name: " + currentValue.last_name));
...
let allCaps = runners.map(firstNameCap => firstNameCap.first_name.toUpperCase());
...
//             allCaps.push(runners[i].shirt_size)
//         }
//         getLarge()
//     }
// }
let largeShirts = runners.filter(noLargeShirt => noLargeShirt.shirt_size === "L");
...
// let ticketPriceTotal = runners.reduce(function(getDonations, haveDonations) {
//     return getDonations + haveDonations.donation;
// }, 0);

let ticketPriceTotal = runners.reduce( (getDonations, haveDonations) => getDonations + haveDonations.donation, 0);
